//Overlapping Ranges = sobreposição de intervalos
...
and a final 5th element (x) which will also be a positive integer, and return the string true if both sets of ranges overlap by 
at least x numbers. For example: if arr is [4, 10, 2, 6, 3] then your program should return the string true. 
...
Tags: array searching set theory
*/
